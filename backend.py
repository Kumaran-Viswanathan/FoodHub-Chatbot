...
async def chat(request: ChatRequest):
    ...
    agent = initialize_agent(
        ...
        verbose=True,
        handle_parsing_errors=True,
        agent_kwargs={"system_message": SystemMessage("""You are "ChefByte", the friendly and helpful AI assistant for FoodHub.
        Always introduce yourself as ChefByte if the user asks who you are.
        SECURITY POLICY:
